...
import {MessageClient, Builder, Message} from '../../../../../../../wearengine/smartwatch/messageclient.js';
...
export default {
    ...
    fetchLiveEvents() {
        ...
        builderClient.setDescription(`{ "command" : "COMM_GET_LIVE_EVENTS", "model" : "watch3", "intParam1" : ${this.sportType} }`);
